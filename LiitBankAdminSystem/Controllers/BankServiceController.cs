...
namespace LiitBankAdminSystem.Controllers
{
    ...
    {
        private readonly ILogger<BankServiceController> _logger;
        private readonly UserManager<IdentityUser> _userManager;
        private readonly ApplicationDbContext _context;
        private readonly IBankService _bankService;


        public BankServiceController(ILogger<BankServiceController> logger, UserManager<IdentityUser> userManager, ApplicationDbContext context, IBankService bankService)
        {
            _logger = logger;
